            ...
            <form action="#" method="post"  id="authorityInfoForm" enctype="multipart/form-data" >
                <div class="modal-body">
                    <div class="form-group">
                        <label for="name">ডিলারের নাম</label>
                        <input type="text" class="form-control" id="name" name="name"  placeholder="ডিলারের নাম">
                    </div>
                    <div class="form-group">
                        <label for="shopName">ডিলারের দোকানের নাম</label>
                        <input type="text" class="form-control" name="shopName" id="shopName" placeholder="দোকানের নাম">
                    </div>
                    <div class="form-group">
                        <label for="address">ডিলারের অবস্থান/ঠিকানা</label>
                        <textarea class="form-control" name="address" id="address" placeholder="ডিলারের অবস্থান/ঠিকানা"></textarea>
                    </div>
                    <div class="form-group">
