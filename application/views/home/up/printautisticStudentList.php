...
<head>
	<meta charset="UTF-8">
	<title>Print Autistic Student List</title>
	<style type="text/css"> 
		*{
			margin: 0px;
			padding: 0px;	
					...
					<td style="text-align:center;">
						<div class="headding-main"> 
							...
							<font style="font-size: 80%; font-weight:bold;">
								...
								<p style="font-size: 120%;font-weight: bold;text-decoration:underline;">প্রতিবন্ধী ছাত্র/ছাত্রী</p>
							</font>
							<?php 
								endif;
							?>
