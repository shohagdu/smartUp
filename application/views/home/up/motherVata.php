<style type="text/css"> 
.count-motherVataList{
	margin-bottom: 20px;
}
.count-motherVataList h4{
	font-size: 18px;
	font-family: SolaimanLipi;
}
.count-motherVataList span{
	color: green;
	font-weight: bolder;
	font-size: 20px;
			...
			<div class="row">
				<div class="col-md-12"> 
					<div class="panel panel-primary">
						<div class="panel-heading" style="font-weight: bold; font-size: 15px;background:#004884;text-align:center;">মাতৃত্বকালীন ভাতা</div>
						<div class="panel-body"  style="min-height:310px;">
							<div class="row"> 
								<div class="col-md-12 col-sm-12 col-xs-12"> 
									<div class="count-motherVataList"> 
										<h4> <?php echo $all_data->full_name;?> এ  <span><?php echo $this->setup->count_motherVata();?></span> জন মাতৃত্বকালীন ভাতা পায় ।আরো অনেকে থাকতে পারে পরর্বতীতে তাদের তথ্য প্রদান করা হবে।</h4>
										
										<p style="font-size: 16px;">তালিকাটি  প্রিন্ট করতে  চাইলে প্রিন্ট বাটনে ক্লিক করুন  
											<a href='Home/printmotherVataList' target='_blank' class="btn btn-primary btn-sm">Print</a>
										</p>
									</div>
								</div>
							</div>
										...
										<table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%" style="color: #000102;font-weight:bolder;">
											...
											<tbody>
												<?php
													$num=0;
													$current_year=date("Y");
													foreach($motherVata_record as $value):
													$num++;
												?>
												<tr>
													<td><?php echo $num;?></td>
