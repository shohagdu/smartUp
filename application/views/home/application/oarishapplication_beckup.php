				...
				<div class="col-md-12"> 
					<div class="panel panel-primary">
						...
						<div class="panel-body all-input-form">
							<form action="javascript:void(0)" method="post" enctype="multipart/form-data" id="defaultForm" class="form-horizontal">
								<div class="row"> 
								...
								<div class="row">
									<div class="col-sm-12"> 
										<div class="form-group">
											...
											<div class="col-sm-3">
												<label class="radio-inline"><input type="radio" name="gender" id="gender" value="male" onchange="testshowHide(this.value);" />পুরুষ </label>
												<label class="radio-inline"><input type="radio" name="gender" id="gender" value="female" onchange="testshowHide(this.value);" />মহিলা</label>
											</div>
											<label for="Marital-status" class="col-sm-3 control-label">বৈবাহিক সম্পর্ক   <span>*</span></label>
											<div class="col-sm-3">
												<label class="radio-inline"><input type="radio" name="mstatus" id="mstatus" value="1" onclick="">বিবাহিত </label>
												<label class="radio-inline"><input type="radio" name="mstatus" id="mstatus" value="2" onclick="">অবিবাহিত</label>
											</div>
										</div>
									</div>
								</div>
