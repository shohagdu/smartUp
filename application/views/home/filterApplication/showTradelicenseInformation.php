...
<base href="<?php echo base_url();?>"/>
	<meta charset="UTF-8">
	<link rel="stylesheet" href="all/assets/search_form_cer_design/trade-form.css" />
	<script>
...
<div style="margin-top:5px;position:middle;background:#666;" align="center" id="bar">
	<a  target='_blank' href="<?php if(isset($_GET['scode'])){?>home/tpreview?pcode=<?php echo $scode;}?>" title="Print"><img src="<?php echo base_url();?>library/print.png"/></a>
</div>
<br/>
	<div class="full"> 
		<div id="wrapper" style="width:92%;">
			...
			<div class="top_area" style="width:98%;">
				<div class="fix structure top_section">
					...
					<div id="top_right">
						<img src="<?php echo $row->profile?>" alt="image" width='140px' height='120px' class="img-responsive" style="padding-top:10px"/>
					</div>
				</div>
			</div>
						<!-----------top area end--------------->
			...
			<div class="app_area">
				<div class="fix structure app_section">
					<div id="app_section_left">
						<form>
							<p> ট্রেকিং আইডি নং - </p><span> <input type="text" name="tra_no" id="" value="<?php echo $row->trackid;?>"/> </span>
						</form>
					</div>
					<div id="app_section_right">
						<table class="table1">
							<tr>
								<td nowrap>&nbsp;প্রতিষ্ঠানের নাম (বাংলা)</td>
								<td nowrap style="border-left:none;border-bottom:none;">&nbsp;:&nbsp;<input type="text" name="ins_name_ban" id="" readonly value="<?php echo $row->bcomname;?>" /></td>
							</tr>
							<tr>
								<td nowrap>&nbsp;প্রতিষ্ঠানের নাম  (ইংরেজী)</td>
					...
					<div class="app_sign_section_inner"> 
						...
						<table class="table3" cellspacing="0" cellpadding="0" style="border-collapse:collapse;margin:20px auto;table-layout:fixed;"> 
							<tr>
								<td></td>
								<td colspan="2"></td>
								<td rowspan="2" style="border-left:1px solid black;border-top:1px solid black;"><br />
							...
							<tr style="55px">
								...
								<td style="border-bottom:1px solid black;"></td>
								<td style="border-bottom:1px solid black;"> <div id="name_sil" > <p style=""> সাক্ষর (সীলসহ) </p></div></td>
							</tr>	
						</table>
					</div>
