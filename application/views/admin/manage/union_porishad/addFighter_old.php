		...
		<div class="row">
			<div class="col-md-12"> 
				<div class="panel panel-primary">
					<div class="panel-heading" style="font-weight: bold; font-size: 15px;background:#004884;text-align:center;">আপনার ইউনিয়ন পরিষদের মুক্তিযোদ্ধার তথ্য যোগ করুন</div>
					<div class="panel-body all-input-form">
						...
						<form action="Manage/addFighter_action" method="post" onsubmit="return validation();" id="fixedInputTest" enctype="multipart/form-data" class="form-horizontal">
							...
							<div class="row medium-font">
								<div class="col-sm-12"> 
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" name="full_name" id="full_name" class="form-control medium-font-inupt fixed_test_valid"placeholder="মুক্তিযোদ্ধার নাম প্রদান করূন" />
										</div>
									</div>
								</div>
							</div>
							<div class="row medium-font">
								<div class="col-sm-12"> 
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" name="father_name" id="father_name" class="form-control medium-font-inupt fixed_test_valid" placeholder="মুক্তিযোদ্ধার পিতার নাম প্রদান করূন " />
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row medium-font">
								<div class="col-sm-12"> 
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" name="sector_no" id="sector_no"  class="form-control medium-font-inupt fixed_test_valid" placeholder="সেক্টর নং প্রদান করূন"  />
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row medium-font">
								<div class="col-sm-12"> 
									<div class="form-group">
										...
										<div class="col-sm-8">
											<textarea name="life_history" class="form-control" id=""  rows="8" ></textarea>
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-offset-3 col-sm-1"> 
									<input type='submit' value="যোগ করুন" name='fighter_add' class="btn btn-info btn-sm"/>
								</div>
