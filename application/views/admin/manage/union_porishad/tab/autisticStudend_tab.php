		...
		<div class="row" style="margin-top: 30px;"> 
			<div class="col-lg-8 col-sm-8"> 
				<h3>প্রতিবন্ধী ছাত্র/ছাত্রী ভাতা প্রাপ্তদের তালিকা </h3>
			</div>
			<div class="col-lg-4 col-sm-4 pull-right" style="padding-top: 15px;"> 
				<a href="Manage/addAutisticStudent">
			...
			<table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
				...
				<thead>
					<tr>
						...
						<th>পিতা/মাতার ন্যাশনাল আইডি </th>
						<th>গ্রাম</th>
						<th>ওয়ার্ড নং</th>
						<th>মোবাইল</th>
						<th>Action</th>
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo @$value->bangla_name;?></td> <!-- ata father name hisabe show hoice--->
						...
						<td>
							...
							<a onclick="return delete_function();" href="<?php echo base_url('Manage/autisticStudentDelete').'/'.$value->tasid;?>" data-toggle="tooltip" title="Delete" class="btn btn-danger btn-sm">
