			...
			<table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<!--<a href="<?php echo base_url('Manage/editWidow').'/'.md5($value->id);?>" data-toggle="tooltip" title="Edit" class="btn btn-primary btn-sm">
								<i class="glyphicon glyphicon-pencil" style="font-size: 10px"></i>
							</a> &nbsp;-->
							<a onclick="return delete_function();" href="<?php echo base_url('Manage/deleteWidow').'/'.$value->wid;?>" data-toggle="tooltip" title="Delete" class="btn btn-danger btn-sm">
