		...
		<div class="row" style="margin-top: 30px;"> 
			<div class="col-lg-8 col-sm-8"> 
				<h3>মাতৃত্বকালীন ভাতা প্রাপ্তদের তালিকা </h3>
			</div>
			<div class="col-lg-4 col-sm-4 pull-right" style="padding-top: 15px;"> 
				<a href="Manage/addMotherVata">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a onclick="return delete_function();" href="<?php echo base_url('Manage/motherVataDelete').'/'.$value->mid;?>" data-toggle="tooltip" title="Delete" class="btn btn-danger btn-sm">
