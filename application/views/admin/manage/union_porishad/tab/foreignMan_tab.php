				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a onclick="return delete_function();" href="<?php echo base_url('Manage/foreignManDelete').'/'.$value->foid;?>" data-toggle="tooltip" title="Delete" class="btn btn-danger btn-sm">
