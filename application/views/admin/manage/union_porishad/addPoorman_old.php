			...
			<div class="col-md-12"> 
				<div class="panel panel-primary">
					...
					<div class="panel-body all-input-form">
						...
						<form action="Manage/addPoorman_action" method="post" onsubmit="return validation();" id="fixedInputTest" enctype="multipart/form-data" class="form-horizontal">
							...
							<div class="row">
								<div class="col-sm-offset-3 col-sm-1"> 
									<input type='submit' value="যোগ করুন" name='poorman_add' class="btn btn-info btn-sm"/>
								</div>
