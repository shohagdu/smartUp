		...
		<div class="row">
			<div class="col-md-12"> 
				<div class="panel panel-primary">
					<div class="panel-heading" style="font-weight: bold; font-size: 15px;background:#004884;text-align:center;">আপনার ইউনিয়ন পরিষদের বয়স্ক ভাতা প্রাপ্তদের তথ্য আপডেট করুন</div>
					<div class="panel-body all-input-form">
						...
						<form action="Manage/updateOldmanstipend_action" method="post" onsubmit="return validation();" id="fixedInputTest" enctype="multipart/form-data" class="form-horizontal">
							
							<div class="row"> 
								<div class="col-sm-12"> 
									<div class="form-group"> 
										<div class="col-sm-6 col-sm-offset-3" id="UPLOAD"> 
											<img src="library/profile/oldmanstipend/<?php if($row->pic !=''): echo $row->pic; else: echo "default.jpg";endif;?>" id="image" name="pic" class="img-thumbnail" style="height:160px;width:180px;" />
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-sm-offset-3 col-sm-1">
									...
									<input type='submit' value="আপডেট করুন" name='oldmanstipend_update' class="btn btn-info btn-sm"/>
								</div>
