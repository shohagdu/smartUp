		...
		<div class="row">
			<div class="col-md-12"> 
				<div class="panel panel-primary">
					<div class="panel-heading" style="font-weight: bold; font-size: 15px;background:#004884;text-align:center;">আপনার ইউনিয়ন পরিষদের মাতৃত্বকালীন ভাতা প্রাপ্তদের তথ্য যোগ করুন</div>
						...
						<div class="row" style="margin-bottom: 10px;"> 
							...
							<div class="col-sm-3 pull-right"> 
								<a href="Manage/unionPorishad">
									<button type="button" class="btn-success btn-sm pull-right">মাতৃত্বকালীন ভাতা প্রাপ্তদের তালিকা</button>
								</a>
							</div>
						</div>
						<form action="Manage/addMotherVata_action" method="post" onsubmit="return validation();" id="motherVataFormId" enctype="multipart/form-data" class="fixedInputTestClass form-horizontal">
							
							<div class="row">
								<div class="col-sm-12"> 
									<div class="form-group">
										<div class="col-sm-3">
											<h3 class="h-style"> ন্যাশনাল আইডি</h3>
										</div>
										<div class="col-sm-3">
											<h3 class="h-style"> নাম </h3>
										</div>
										<div class="col-sm-2">
							...
							<div class="row medium-font">
								<div class="col-sm-12"> 
									<div class="form-group">
										...
										<div class="col-sm-3">
											<input type="text" name="bangla_name[]" id="bname" class="form-control medium-font-inupt fixed_test_valid" readonly />
										</div>
										<div class="col-sm-2">
...
<script type="text/javascript"> <!--------this is for Client Search ------>
	$("document").ready(function(){
		$("#n_id").keyup(function(){
			var n_id=$("#n_id").val();
			//alert(n_id);exit;
			var tbl_mother_vata = 'tbl_mother_vata' // it's table name
			if(n_id.trim()==""){
				$('#motherVataFormId').trigger('reset');
			...
			$.ajax({
				url:"Manage/searchVoterInfo?tbl="+tbl_mother_vata,
				data:{n_id:n_id},
				type:"GET",
				success:function(hr){
					...
					if(hr==1){
						...
						document.getElementById('bname').value=d[1];
						document.getElementById('fname').value=d[2];
