			...
			<div class="col-md-12"> 
				<div class="panel panel-primary">
					...
					<div class="panel-body all-input-form">
						...
						<form action="Manage/addOldmanstipend_action" method="post" onsubmit="return validation();" id="oldmanstipendFormId" enctype="multipart/form-data" class="fixedInputTestClass form-horizontal">
			...
			$.post(
				...
				function(data){
					...
					if(data==1){
						...
						var n_id = document.getElementById('n_id').value;
						$('#oldmanstipendFormId').trigger('reset');
...
<script type="text/javascript"> <!--------this is for Client Search ------>
	$("document").ready(function(){
		$("#n_id").keyup(function(){
			var n_id=$("#n_id").val();
			//alert(n_id);exit;
			var tbl_oldmanstipend = 'tbl_oldmanstipend' // it's table name
			if(n_id.trim()==""){
				$('#oldmanstipendFormId').trigger('reset');
			...
			$.ajax({
				url:"Manage/searchVoterInfo?tbl="+tbl_oldmanstipend,
				data:{n_id:n_id},
				type:"GET",
				success:function(hr){
