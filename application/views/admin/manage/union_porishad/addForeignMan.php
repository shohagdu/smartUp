		...
		<div class="row">
			<div class="col-md-12"> 
				<div class="panel panel-primary">
					<div class="panel-heading" style="font-weight: bold; font-size: 15px;background:#004884;text-align:center;">আপনার ইউনিয়ন পরিষদের প্রবাসীদের তথ্য যোগ করুন</div>
						...
						<div class="row" style="margin-bottom: 10px;"> 
							...
							<div class="col-sm-3 pull-right"> 
								<a href="Manage/unionPorishad">
									<button type="button" class="btn-success btn-sm pull-right">প্রবাসীদের তালিকা</button>
								</a>
							</div>
						</div>
						<form action="Manage/addForeignMan_action" method="post" onsubmit="return validation();" id="foreignManFormId" enctype="multipart/form-data" class="fixedInputTestClass form-horizontal">
			...
			$.post(
				...
				function(data){
					...
					if(data==1){
						...
						var n_id = document.getElementById('n_id').value;
						$('#foreignManFormId').trigger('reset');
...
<script type="text/javascript"> <!--------this is for Client Search ------>
	$("document").ready(function(){
		$("#n_id").keyup(function(){
			var n_id=$("#n_id").val();
			//alert(n_id);exit;
			var tbl_foreignMan = 'tbl_foreignMan' // it's table name
			if(n_id.trim()==""){
				$('#foreignManFormId').trigger('reset');
			...
			$.ajax({
				url:"Manage/searchVoterInfo?tbl="+tbl_foreignMan,
				data:{n_id:n_id},
				type:"GET",
				success:function(hr){
