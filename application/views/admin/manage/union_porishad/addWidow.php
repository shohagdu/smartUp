		...
		<div class="row">
			<div class="col-md-12"> 
				<div class="panel panel-primary">
					<div class="panel-heading" style="font-weight: bold; font-size: 15px;background:#004884;text-align:center;">আপনার ইউনিয়ন পরিষদের বিধবাদের তথ্য যোগ করুন</div>
						...
						<div class="row" style="margin-bottom: 10px;"> 
							...
							<div class="col-sm-3 pull-right"> 
								<a href="Manage/unionPorishad">
									<button type="button" class="btn-success btn-sm pull-right">বিধবাদের তালিকা</button>
								</a>
							</div>
						</div>
						<form action="Manage/addWidow_action" method="post" onsubmit="return validation();" id="widowFormId" enctype="multipart/form-data" class="fixedInputTestClass form-horizontal">
...
<script type="text/javascript"> <!--------this is for Client Search ------>
	$("document").ready(function(){
		$("#n_id").keyup(function(){
			var n_id=$("#n_id").val();
			//alert(n_id);exit;
			var tbl_widow = 'tbl_widow' // it's table name
			if(n_id.trim()==""){
				$('#widowFormId').trigger('reset');
			...
			$.ajax({
				url:"Manage/searchVoterInfo?tbl="+tbl_widow,
				data:{n_id:n_id},
				type:"GET",
				success:function(hr){
