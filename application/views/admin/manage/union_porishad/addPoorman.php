		...
		<div class="row">
			<div class="col-md-12"> 
				<div class="panel panel-primary">
					<div class="panel-heading" style="font-weight: bold; font-size: 15px;background:#004884;text-align:center;">আপনার ইউনিয়ন পরিষদের দস্থ ও হত দরিদ্রদের তথ্য যোগ করুন</div>
					<div class="panel-body all-input-form">
						...
						<form action="Manage/addPoorman_action" method="post" onsubmit="return validation();" id="poormanFormId" enctype="multipart/form-data" class="fixedInputTestClass form-horizontal">
...
<script type="text/javascript"> <!--------this is for Client Search ------>
	$("document").ready(function(){
		$("#n_id").keyup(function(){
			var n_id=$("#n_id").val();
			//alert(n_id);exit;
			var tbl_poormans = 'tbl_poormans' // it's table name
			if(n_id.trim()==""){
				$('#poormanFormId').trigger('reset');
			...
			$.ajax({
				url:"Manage/searchVoterInfo?tbl="+tbl_poormans,
				data:{n_id:n_id},
				type:"GET",
				success:function(hr){
