	<div id="content" class="col-lg-10 col-sm-10">
				...
				$('#confirmTradelicenseGenarate').submit(function() {
					...
					function(data){
						if(data==1)
						{
							...
							$("#globalmsg").show("normal").html('<p class="done">আপনার ট্রেড লাইসেন্সটি সঠিকভাবে তৈরি হয়েছে মানি রিসিট গ্রহণ করুন</p>');
							setTimeout(function() {
		...
		<div class="row">
			<div class="col-lg-12 col-sm-12 col-xs-12"> 
				<button class="btn btn-custom-head btn-block btn-sm" style="font-size:16px;margin-bottom:30px;">Confirm ট্রেড লাইসেন্স  আবেদন জেনারেট </button>
			</div>
				<!-- Form -->
			<div class="col-lg-9 col-sm-9 col-lg-offset-3 col-sm-offset-3"> 
				<form name="tradeform" action="Genarate/tradelicenseGenarate_action" method="post" id="confirmTradelicenseGenarate">
					...
					<div class="form-group"> 
						<div class="col-sm-9 col-sm-offset-3">
							...
							<a href="Genarate/tradelicenseGenarate?id=<?php echo sha1($trackid);?>" class="btn btn-primary btn-sm">
								Back
							</a>
