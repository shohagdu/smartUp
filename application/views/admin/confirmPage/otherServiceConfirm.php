	<div id="content" class="col-lg-10 col-sm-10">
		...
		<script type="text/javascript">
			$(document).ready(function(){
				$('#confirmOtherServiceGenaret').submit(function() {
					$("#load").empty().append('<img src="library/img/ajaxloader.gif">');
					$.post(
					"Genarate/otherServiceGenarate_action",
					$("#confirmOtherServiceGenaret").serialize(),
					function(data){
						if(data==1)
						{
							document.getElementById('save_tlicence').type='button';
							$("#globalmsg").show("normal").html('<p class="done">আপনার সনদ সঠিকভাবে তৈরি হয়েছে,আপনি মানি রিসিট গ্রহণ করুন</p>');
							setTimeout(function() {
							window.location='Applicant/otherService?napply=5&service='+<?php echo $serviceId?>;}, 2000)	
						}
						else{alert(data);}
					});
					return false;
		...
		<div class="row">
			...
			<div class="col-lg-9 col-sm-9 col-lg-offset-3 col-sm-offset-3"> 
				<form action="Genarate/otherServiceGenarate_action" method="post" id="confirmOtherServiceGenaret" enctype="multipart/form-data">
