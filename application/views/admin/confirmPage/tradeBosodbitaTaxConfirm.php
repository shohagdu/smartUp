	<div id="content" class="col-lg-10 col-sm-10">
				...
				$('#tradeLicense').submit(function() {
					...
					function(data){
						if(data==1)
						{
							...
							window.open('Money_receipt/tradeBosodbitakorMoneyReceipt', '_blank');}, 2000)
						}
		...
		<div class="row"> 
			<div class="col-lg-12 col-sm-12 col-xs-12"> 
				<button class="btn btn-custom-head btn-block btn-sm" style="font-size:16px;margin-bottom:30px;">Confirm ট্রেড লাইসেন্সধারির বসতভিটা কর</button>
			</div>
		</div>
		<div class="col-lg-9 col-sm-9 col-lg-offset-3 col-sm-offset-3"> 
			
			<form action="Admin/boshodbitakorTaxCollection" method="post" id="tradeLicense">
				...
				<div class="form-group"> 
					...
					<div class="col-sm-9 col-xs-6"> 
						<input type="hidden" name="tredeVillage" id="tredeVillage" value='<?php echo $tredeVillage?>'  readonly />
