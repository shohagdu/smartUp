				...
				<div id="muri"> 
					<table border="0px" height="60px" width="97%"  cellspacing="0"  cellpadding="0" style="border-collapse:collapse;margin:0px auto;">
						<tr height="55px">
							...
							<td <?php if($header==0) { ?> class="no-print" <?php } ?> style="text-align:center;height:55px;font-family:SolaimanLipi;thoma;"><font style="font-size:15px; font-weight:bold; color:blue; width:5.5in;"><?php echo (!empty($all_data->full_name_english) ? $all_data->full_name_english : '');?></font>  <br />
					...
					<table width="97%" height='246px' border='0' class="muri_table" style="border-collapse:collapse;margin:0px auto;"> 
						...
						<tr> 
							<td style="font-size:14px;vertical-align:middle;">Serial No</td>
							<td style="width:330px;" >: <input type="text"  value="<?php echo $row_Seril_Date->applicnat_id?>" style="width:95%;font-size:13px;border-bottom:1px dashed black;" readonly /></td>
							<td style="font-size:14px;vertical-align:middle;">Date</td>
						...
						<tr>
							<td style="font-size:14px;vertical-align:middle;">Certificate No</td>
						...
						<tr>
							<td style="font-size:14px;vertical-align:middle;"> Name </td>
						...
						<tr>
							<td style="font-size:14px;vertical-align:middle;"> Father Name </td>
						...
						<tr>
							<td style="font-size:14px;vertical-align:middle;">Permanent address</td>
						...
						<tr>
							...
							<td style="font-size:14px;vertical-align:middle;">National Id</td>
							
							<?php } else if(isset($row->bcno) && $row->bcno!=''){?>
							
							<td style="font-size:14px;vertical-align:middle;"> Birth Certificate No</td>
							
							<?php } else if(isset($row->pno) && $row->pno!=''){?>
							<td style="font-size:14px;vertical-align:middle;">Passport No </td>
							...
							<input type="text" value='<?php echo $row->nationid?>' style="width:265px;font-size:13px;border-bottom:1px dashed black;" readonly />
							<?php }?>
							<span style="font-size: 14px;">Ward No</span>
						...
						<tr> 
							<td colspan="3"></td>
							<td style="width:30px;text-align:center;border-top:1px solid black;font-size:14px;">Chairman Signature</td>
						</tr>
					</table>
				</div>
				<?php 
					...
					<div id="cert" <?php if($muri==0):echo $cert2;endif;?>>
						...
						<table border="0" height="400px" width='99%' cellspacing="0" cellspacing='0' style="border-collapse:collapse;margin:0px auto;">
							...
							<tr height="18px">
								...
								<td>
									<font style="font-size:17px;">:  <?php echo ($row->p_wordno != 0 ? $row->p_wordno : '') ?></font>
									<label style='margin-left: 250px;' for="holding_no">Holding Number</label><span style='margin-left: 10px;' id='holding_no'>: <?php echo $row->holding_no; ?></span>
								</td>
							</tr>
