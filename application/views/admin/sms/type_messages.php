			...
			<div class="col-md-12"> 
				<div class="panel panel-primary">
					...
					<div class="panel-body all-input-form">
						<form action="setup/type_messages_sub" method="post" onsubmit="return validation();" id="validall" enctype="multipart/form-data" class="form-horizontal">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<select name='sms_type' id='sms_type' class="form-control highlisht_font" required>
											  ...
											  <option value='1'>নাগরিক/ওয়ারিশ/ট্রেড লাইসেন্স আবেদন</option>
											  <option value='2'>নাগরিক/ওয়ারিশ/ট্রেড লাইসেন্স  সনদ তৈরি</option>
											  <option value='3'>ট্রেড লাইসেন্স  নবায়ন</option>
											  <option value='4'>ট্রেড লাইসেন্স  নবায়ন নোটিশ</option>
											</select>
							...
							<div class="row medium-font">
								<div class="col-sm-12"> 
									<div class="form-group">
										...
										<div class="col-sm-6">
											<textarea name="msg" id="message" class="form-control highlisht_font" cols='10' rows='10' required></textarea>
										</div>
									</div>
								</div>
							</div>
