    ...
    <div>
        <div class="panel panel-primary">
            <div class="panel-heading">
                ...
                <div class="col-sm-4">
                    <button type="button"  data-toggle="modal" onclick="addAuthorityInfo()" data-target="#impleAuthModal" class="btn btn-success btn-xs pull-right"><i class="glyphicon glyphicon-plus"></i> নতুন যোগ করুন </button>
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table id="exampleNew2" class="table table-bordered table-striped">
                        <thead>
                        <tr>
                            <th width="3%">S/L</th>
                            <th>নাম</th>
                        ...
                        if(!empty($record)){
                            foreach ($record as $row){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" data-toggle="modal"  data-target="#impleAuthModal" onclick="editAuthorityInfoVGD('<?php echo $row->id  ?>')" name="update" class="btn btn-info btn-xs" title="Edit"><i class="glyphicon glyphicon-pencil"></i> Edit </button>
...
<div class="modal fade" id="impleAuthModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
