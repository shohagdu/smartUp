...
$nrow=$query->row(); 
$mQy=$this->db->select('*')->from('tbl_wcc')->where('sha1(trackid)',$id)->order_by('id','DESC')->limit(1)->get();
$mrow=$mQy->row();
...
<table  style="font-size:13px;" width="100%" cellspacing="0" cellpadding="0" border="0">
		...
		<td colspan="4">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<td width="25%"  height='90px' style="padding-top:50px;"><b style="font-weight:normal;">তারিখ</b> :  <?php $moneyDate=date("d/m/y",strtotime($myrow->payment_date));echo $this->web->banDate($moneyDate)?>&nbsp;&nbsp;&nbsp;&nbsp;<img src="pori/print.png" onclick="window.print()" id="hide" height="30" width="30"></td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr> 
		<td><b>ভাউচার নং</b></td>
		<td colspan="3">
			<font>&nbsp;:&nbsp;<?php echo $this->web->conArray($mrow->vno);?></font>
		</td>
	</tr>
	<tr>
		...
		<td colspan="4">
			<table class="tbl_style" width="100%" cellpadding="0" cellspacing="0"> 
				...
				<tr>
					...
					<td style="height:90px;text-align:left;text-indent:20px;font-size:14px;padding-top:3px;" valign='top'>ওয়ারিশ সনদ</td>
					<td valign='top' style="text-align:center;"><?php echo $this->web->conArray($mrow->fee);?></td>
				</tr>
				<tr> 
					<td colspan='2' height='23' style="text-align:right; font-size:12px;"> মোট টাকার পরিমান  &nbsp;&nbsp;</td>
					<td height='23' style="text-align:right;padding-right:20px; font-size:12px;"> <?php echo $this->web->conArray($mrow->fee);?>&nbsp; টাকা। </td>
				</tr>
			</table>
		</td>
	</tr>
	<tr style="height:40px;"> 
		<td colspan="4"><font style="font-size:12px;">  কথায় : &nbsp; &nbsp;  <input type="text" readonly  style="border-bottom:1px dotted black; border-top:none; border-left:none; border-right:none; background:none; width:360px; font-size:12px; text-align:left;" value="<?php echo $this->bnc->bnConvert($mrow->fee);?>&nbsp;টাকা মাত্র" id="ftaka"/></font></td>
	</tr>
	<tr>
...
<table  style="font-size:13px;" width="100%" cellspacing="0" cellpadding="0" border="0">
	...
	<tr style="height:40px;"> 
		<td colspan="4"><font style="font-size:12px;">  কথায় : &nbsp; &nbsp;  <input type="text" readonly  style="border-bottom:1px dotted black; border-top:none; border-left:none; border-right:none; background:none; width:360px; font-size:12px; text-align:left;" value="<?php echo $this->web->tkconvert($mrow->fee);?>&nbsp;টাকা মাত্র" id="btaka"/></font></td>
	</tr>
	<tr>
		<td colspan="4" style="height:60px;"></td>
	</tr>
