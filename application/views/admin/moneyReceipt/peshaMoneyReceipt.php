<html>
	<head>
		...
		<title>পেশাজীবি কর মানি রসিদ </title>
		<style>
		body{
	...
	<tr> 
		<td colspan="4">
			<table class="tbl_style" width="100%" cellpadding="0" cellspacing="0"> 
				...
				<tr>
					<td style="height:18px;text-align:center;border-bottom:1px solid #ddd;padding-top:1px;font-size:13px;" valign='top'>১</td>
					<td style="height:18px;text-align:left;border-bottom:1px solid #ddd;padding-top:1px;font-size:13px;text-indent:20px;" valign='top'>পেশাজীবি কর</td>
...
<table  style="font-size:13px;" width="100%" cellspacing="0" cellpadding="0" border="0">
	...
	<tr style="height:40px;"> 
		<td colspan="4"><font style="font-size:13px;">  কথায় : &nbsp; &nbsp;  <input type="text" readonly  style="border-bottom:1px dotted black; border-top:none; border-left:none; border-right:none; background:none; width:360px; font-size:13px; text-align:left;" value="<?php echo $this->web->tkconvert($row->total);?>&nbsp;টাকা মাত্র" id="btaka"/></font></td>
	</tr>
	<tr>
