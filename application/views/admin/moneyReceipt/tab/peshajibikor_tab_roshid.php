		...
		<table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="Money_receipt/peshaMoneyReceipt?id=<?php echo $row->id?>&vno=<?php echo $row->inno?>&sno=<?php echo $row->trackid?>" class='btn btn-success btn-sm' target='_blank'>প্রিন্ট</a></td>
				</tr>
				<?php $ir++;endforeach;?>	
			</tbody>
		</table>
