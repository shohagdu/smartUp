		...
		<table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="Money_receipt/dailyCollectionMoneyReceipt?id=<?php echo md5($row->id);?>" class='btn btn-success btn-sm' target='_blank'>প্রিন্ট</a></td>
				</tr>
				<?php $col++;endforeach;?>	
			</tbody>
		</table>
