	...
	<div  class="row box">
		...
		<div class="col-lg-12 col-sm-12">
			<form class="form-inline" role="form">
				...
				<button type="button" onclick="htmlData('DailyReports/dailyBankReportSearch','ac='+ac.value+'&to='+to_date.value+'&from='+from_date.value)" class="btn btn-info">Submit</button>
			</form>
		</div>
	</div>
