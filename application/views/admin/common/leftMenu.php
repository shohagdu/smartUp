            ...
            <div class="sidebar-nav">
                <div class="nav-canvas" style="">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
						...
						<li>
							<a class="ajax-link" href="Admin/taxCollection" <?php $this->chk->acl('taxCollection'); ?>>
								<i class="glyphicon glyphicon-tags"></i> &nbsp;
								<span>  কর আদায় </span>
							</a>
						</li>
						<li>
							<a class="ajax-link" href="Setup_section/assessmentForm" <?php $this->chk->acl('assessmentForm'); ?>>
								<i class="glyphicon glyphicon-tags"></i> &nbsp;
								<span> ট্যাক্স  এ্যাসেসমেন্ট  ফরম</span>
							</a>
						</li>
						...
						<li class="accordion">
                            ...
                            <ul class="nav nav-pills nav-stacked">
								<li><a href="DailyReports/dailyShortReport"  target='_blank' <?php $this->chk->acl('dailyCollection'); ?>>দৈনিক প্রতিবেদন</a></li>
					...
					<li class="nav-header hidden-md"><p style="text-align: right;letter-spacing: 1px;">version 3.8</p></li>
                </div>
            </div>
        </div>
        <!--/span-->
